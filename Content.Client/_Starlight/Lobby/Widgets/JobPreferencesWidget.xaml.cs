// SPDX-FileCopyrightText: 2025 Afterlight RnD (Modified from Space Wizards Federation)
// SPDX-License-Identifier: ASL-1.0, MIT
...
public sealed partial class JobPreferencesWidget : UIWidget
{
    ...
    private Tooltip? CreateJobTooltip(JobPrototype job)
    {
        ...
        {
            MaxGridHeight = UserInterfaceManager.PopupRoot.Height * 0.99f, Margin = new Thickness(6),
        };
        ...
        foreach (var profile in profiles.Values)
        {
            ...
            {
                SetSize = new Vector2(64), Scale = new Vector2(2), HorizontalAlignment = HAlignment.Right,
            };
            if (!profile.Enabled)
            ...
            var profileContainer = new BoxContainer { Orientation = BoxContainer.LayoutOrientation.Horizontal, };
