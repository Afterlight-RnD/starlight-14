...
public sealed partial class LobbyInfoWidget : SLWidget
{
    ...
    private ClientGameTicker GameTicker => _gameTicker ?? EntityManager.System<ClientGameTicker>();
    ...
    {
        GameTicker.InfoBlobUpdated += UpdateInfo;
    }
    ...
    {
        var text = GameTicker.ServerInfoBlob;
        if (text == null)
        {
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        {
            var roundTime = _gameTiming.CurTime.Subtract(GameTicker.RoundStartTimeSpan);
