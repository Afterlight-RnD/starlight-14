...
public sealed partial class SpeciesSelectorPanel : CharacterEditorPanel
{
    ...
    {
        CustomSpeciesName.InitializeAsTextField<CharacterSpeciesData>(
            SetCustomSpeciesField, GetCustomSpeciesField);
    }
    ...
    private void SetCustomSpeciesField(string name, ref CharacterSpeciesData data)
    {
