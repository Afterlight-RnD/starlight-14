...
public sealed partial class CharacterPreviewWidget : UIWidget
{
    ...
    {
        CharacterSpritePreview.SetEntity(null);
        CharacterName.Text = "N/A"; //TODO: localize
    }

    private void OnCharacterEditStart(CharacterEditingStartedUIEvent ev)
    {
    ...
    {
        CharacterName.Text = ev.Profile.GetData<LegacyCharacterData>().LegacyProfile.Name;
    }
}
